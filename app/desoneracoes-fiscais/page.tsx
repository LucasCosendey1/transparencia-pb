      ...
      <div className={`${highContrast ? 'bg-black' : 'bg-white'} border-b mt-32`}>
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center text-sm">
            ...
            <span className={highContrast ? 'text-yellow-300' : 'text-gray-600'}>Desonerações Fiscais Concedidas</span>
          </div>
        </div>
      </div>
      ...
      <main className={`${highContrast ? 'bg-black' : 'bg-gray-50'} py-12`}>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className={`text-4xl font-bold mb-8 ${highContrast ? 'text-yellow-300' : 'text-gray-800'}`}>
            Desonerações Fiscais Concedidas
          </h1>

          {/* Botão de Download */}
          <div className="mb-8">
            <a 
              href="/Desoneracoes.pdf" 
              target="_blank"
