// app/api/arquivos-tabela/[paginaId]/route.ts
...
// GET /api/arquivos-tabela/[paginaId]?categoria=pdf
    ...
    for (const cat of categoriasParaBuscar) {
      ...
      for (const item of lista) {
        ...
        arquivos.push({
          ...
          tamanho: item.size,
          categoria: cat,
          // URL CORRETA para rota Next.js
          url: `/api/uploads/${paginaId}/${cat}/${item.name}`,
...
// DELETE /api/arquivos-tabela/[paginaId] body: { nome, categoria }
