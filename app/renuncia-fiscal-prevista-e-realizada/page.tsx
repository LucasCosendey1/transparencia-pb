...
export default function RenunciaFiscalPage() {
      ...
      <div className={`${highContrast ? 'bg-black' : 'bg-white'} border-b mt-32`}>
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center text-sm">
            ...
            <span className={highContrast ? 'text-yellow-300' : 'text-gray-600'}>Renúncia Fiscal Prevista e Realizada</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className={`${highContrast ? 'bg-gray-900' : 'bg-white'} rounded-lg shadow-md p-4`}>
            ...
            <div className="w-full" style={{ height: '800px' }}>
              <iframe
                src="/Renuncias-Fiscais-prevista.pdf"
                className="w-full h-full border-0 rounded"
                title="Renúncia Fiscal Prevista e Realizada"
              />
            </div>
          </div>
        </div>
