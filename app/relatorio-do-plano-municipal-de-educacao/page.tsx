    ...
    >
      ...
      <div className={`${highContrast ? 'bg-black' : 'bg-white'} border-b mt-32`}>
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center text-sm">
            ...
            <span className={highContrast ? 'text-yellow-300' : 'text-gray-600'}>Relatório do Plano Municipal de Educação</span>
          </div>
        </div>
      </div>
      ...
      <main className={`${highContrast ? 'bg-black' : 'bg-gray-50'} py-12`}>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mb-8">
            <a 
              href="/Relatorio-Anual-de-Monitoramento-do-PME_ITABAIANA.pdf" 
              download
          ...
          <div className={`${highContrast ? 'bg-gray-900' : 'bg-white'} rounded-lg shadow-md p-4`}>
            <div className="flex items-center gap-2 mb-4 pb-4 border-b">
              ...
              <h2 className={`text-xl font-semibold ${highContrast ? 'text-yellow-300' : 'text-gray-800'}`}>
                Visualizar Relatório do Plano Municipal de Educação
              </h2>
            </div>
            
            <div className="w-full" style={{ height: '800px' }}>
              <iframe
                src="/Relatorio-Anual-de-Monitoramento-do-PME_ITABAIANA.pdf"
